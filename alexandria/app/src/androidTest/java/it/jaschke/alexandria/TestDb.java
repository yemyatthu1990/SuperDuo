...
public class TestDb extends AndroidTestCase {
  ...
  public final static String imgUrl =
      "http://books.google.com/books/content?id=KI2WQgAACAAJ&printsec=frontcover&img=1&zoom=1";
  ...
  public void testInsertReadDb() {
    ...
    String[] columns = {
        AlexandriaContract.BookEntry._ID, AlexandriaContract.BookEntry.TITLE,
        AlexandriaContract.BookEntry.IMAGE_URL, AlexandriaContract.BookEntry.SUBTITLE,
        AlexandriaContract.BookEntry.DESC
    };

    // A cursor is your primary interface to the query results.
    Cursor cursor = db.query(AlexandriaContract.BookEntry.TABLE_NAME,  // Table to Query
    ...
    columns = new String[] {
        AlexandriaContract.AuthorEntry._ID, AlexandriaContract.AuthorEntry.AUTHOR
    };

    cursor = db.query(AlexandriaContract.AuthorEntry.TABLE_NAME,  // Table to Query
        columns, null, // Columns for the "where" clause
        null, // Values for the "where" clause
        null, // columns to group by
        null, // columns to filter by row groups
    ...
    cursor = db.query(AlexandriaContract.CategoryEntry.TABLE_NAME,  // Table to Query
        columns, null, // Columns for the "where" clause
        null, // Values for the "where" clause
        null, // columns to group by
        null, // columns to filter by row groups
